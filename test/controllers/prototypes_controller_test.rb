...
class PrototypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prototype" do
    assert_difference('Prototype.count') do
      post prototypes_url, params: { prototype: { catch: @prototype.catch, concept: @prototype.concept, title: @prototype.title } }
    end
  ...
  test "should update prototype" do
    patch prototype_url(@prototype), params: { prototype: { catch: @prototype.catch, concept: @prototype.concept, title: @prototype.title } }
